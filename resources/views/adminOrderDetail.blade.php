            ...
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-8 offset-2">
                        <div class="row ">
                            <div class="col-3 ">
                                <p class="mt-1">Customer Name </p class="mt-3">
                            </div>
                            <div class="col-9 ">
                                <p class="fs-5 mt-2">: {{$order->first_name}} {{$order->last_name}}</p>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-3 ">
                                <p class="mt-1">Email </p class="mt-3">
                            </div>
                            <div class="col-9 ">
                        ...
                        <div class="row ">
                            <div class="col-3 ">
                                <p class="mt-1">Address </p class="mt-3">
                            </div>
                            <div class="col-9 ">
                                <p class="fs-5">: {{$order->street}},&nbsp;{{$order->town}},&nbsp;{{$order->city}}</p>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-3 ">
                                <p class="mt-1">Phone </p class="mt-3">
                            </div>
                            <div class="col-9 ">
                            ...
                            <tbody class="align-middle">
                                @foreach (json_decode($order->records,true) as $key => $value)
                                        <tr>
                                            ...
                                            <td class="align-middle">{{$value['price']}} mmk</td>
                                            <td class="align-middle">{{$value['qty']}} </td>
                                            <td class="align-middle">{{$value['subtotal']}} mmk</td>
                                        </tr>
                                    @endforeach
                                    <tr>
