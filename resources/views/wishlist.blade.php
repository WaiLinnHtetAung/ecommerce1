    ...
    <div class="row pt-3">
        <div class="col-lg-8 offset-lg-2 col-md-12">
          ...
          <div class="p-3 border rounded mb-2">
            <div class="row">
                <div class="col-4">
                    <img src="{{$wish->options['url']}}" style="width:auto;height:100px" class="img-fluid" alt="...">
                </div>
       ...
       <div class="mt-2 d-flex justify-content-end align-items-center">
        <button class="btn btn-danger" onclick="location='{{route('wishlist.removeall')}}'">Remove All</button>
       </div>
       @else
       <div class="p-3 border rounded mb-2 d-flex flex-column justify-content-center align-items-center">
           ...
           <button onclick="location='{{route('cart')}}'" class="btn btn-info text-white" >Continue Shopping</button>
       </div>
          @endif
        </div>
    </div>
